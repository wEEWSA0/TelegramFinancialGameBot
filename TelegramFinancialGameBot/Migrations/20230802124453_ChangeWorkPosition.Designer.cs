...
namespace TelegramFinancialGameBot.Migrations
{
    ...
    [Migration("20230802124453_ChangeWorkPosition")]
    partial class ChangeWorkPosition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelegramFinancialGameBot.Model.UserAccident", b =>
                {
            ...
            modelBuilder.Entity("TelegramFinancialGameBot.Model.UserWorkPosition", b =>
                {
                    ...
                    b.HasKey("UserId", "WorkPositionId");
            ...
            modelBuilder.Entity("TelegramFinancialGameBot.Model.WorkPosition", b =>
                {
                    ...
                    b.HasIndex("WorkId", "ExpirienceRequire")
                        .IsUnique();
            ...
            modelBuilder.Entity("TelegramFinancialGameBot.Model.UserAccident", b =>
                {
                    b.HasOne("TelegramFinancialGameBot.Model.Accident", "Accident")
                        .WithMany()
